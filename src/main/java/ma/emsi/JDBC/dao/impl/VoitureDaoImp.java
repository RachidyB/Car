    ...
    public void importExcel(String s) {
        ...
        try {
            ...
            for (Row row : sheet) {
                ...
                Double prix = Double.parseDouble(String.valueOf(row.getCell(3).getNumericCellValue()));
                Double kilometrage = Double.parseDouble(String.valueOf(row.getCell(4).getNumericCellValue()));
                Double vitesse = Double.parseDouble(String.valueOf(row.getCell(5).getNumericCellValue()));
